...
`<scene>` tags enclose data indicating who is speaking along with one or more sentences of the transcribed text from their recording. `<scene>` tags also include attributes indicating the position or scene's *id*,


dentification of a speaker, and one or more sentences of transcribed text from that speaker.  
~~~
...
<scene id="4" in="00:00:19.08" out="00:00:21.14">
